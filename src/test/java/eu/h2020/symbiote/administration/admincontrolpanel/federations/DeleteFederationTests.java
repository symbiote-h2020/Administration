...
public class DeleteFederationTests extends AdminControlPanelBaseTestClass {
    ...
    public void success() throws Exception {
        ...
        doReturn(sampleFederationRuleManagementResponse()).when(mockRabbitManager).sendDeleteFederationRequest(any());
    ...
    public void aamTimeout() throws Exception {
        ...
        doReturn(null).when(mockRabbitManager).sendDeleteFederationRequest(any());
    ...
    public void aamCommunicationException() throws Exception {
        ...
        doThrow(new CommunicationException("error")).when(mockRabbitManager).sendDeleteFederationRequest(any());
